...
export function Connect() {
    ...
    return (
        <section className="relative mx-auto mb-20 mt-20 max-w-5xl px-4">
                                ...
                                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                                    ...
                                    >
                                        ...
                                        <div id="pointer" className="absolute">
                                            ...
                                            <span className="relative -top-1 left-3 rounded-3xl bg-green-500 px-2 py-1 text-xs text-white">
                                                You
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                                        ...
                                        <p className="mb-4 text-center text-slate-400 md:text-left">
                                            Let&apos;s bring your ideas to life. Reach out today!
                                        </p>
                                        <div className="flex flex-wrap justify-center gap-2 md:justify-start">
                                            <Link href="mailto:kelvinwamuiga@gmail.com">
