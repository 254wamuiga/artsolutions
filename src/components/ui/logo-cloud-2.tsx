    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <PlusIcon
                    className="-bottom-[12.5px] -left-[12.5px] absolute z-10 hidden size-6 md:block text-border"
                    strokeWidth={1}
                />
            </LogoCard>
            ...
            >
                <PlusIcon
                    className="-right-[12.5px] -bottom-[12.5px] md:-left-[12.5px] absolute z-10 size-6 md:hidden text-border"
                    strokeWidth={1}
                />
            </LogoCard>
...
function LogoCard({ logo, className, children, ...props }: LogoCardProps) {
    return (
        <div
            className={cn(
                "flex items-center justify-center bg-background px-4 py-8 md:p-12",
                className
            )}
            {...props}
        >
            <img
                alt={logo.alt}
                className="pointer-events-none h-4 select-none md:h-6 dark:brightness-0 dark:invert opacity-70"
